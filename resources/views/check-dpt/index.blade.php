            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-blue-900/10 border border-white/60 p-8 md:p-12 relative overflow-hidden" x-data="dptSearch()">
                ...
                <div x-show="notFound" style="display: none;"
                    ...
                    <p class="text-slate-500 text-sm max-w-xs mx-auto">
                     ...
                     <div class="mt-6">
                        <a :href="'https://wa.me/6285183750294?text=' + encodeURIComponent('Halo Panitia Pemilu Mahasiswa, perkenalkan NIM saya ' + nim + '. Saya ingin mengonfirmasi bahwa setelah saya cek di website, NIM saya belum terdaftar di DPT. Mohon arahannya.')" target="_blank" class="inline-flex items-center px-4 py-2 bg-white border border-slate-200 rounded-lg shadow-sm text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900">
