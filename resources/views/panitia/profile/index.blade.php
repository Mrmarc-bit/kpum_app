<x-layouts.panitia title="Profil Saya">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col items-center text-center relative overflow-hidden">
                    ...
                    <div class="absolute top-0 left-0 w-full h-24 bg-gradient-to-br from-purple-500 to-pink-600"></div>
                    
                    <!-- Avatar Upload -->
                    <div class="relative mt-12 mb-4 group cursor-pointer" onclick="document.getElementById('avatarInput').click()">
                        <div class="w-24 h-24 rounded-full bg-white p-1 shadow-lg ring-4 ring-purple-50/50 relative overflow-hidden">
                            ...
                            @else
                                <div id="avatarFallback" class="w-full h-full rounded-full bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center text-white text-3xl font-bold transition-transform group-hover:scale-110">
                ...
                <!-- Tips / Info Card -->
                <div class="bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl p-6 text-white shadow-lg shadow-pink-500/20 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-pink-100 text-sm leading-relaxed">
                            Pastikan data pribadi Anda selalu mutakhir untuk memudahkan komunikasi selama periode pemilihan.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('panitia.profile.update') }}" method="POST" enctype="multipart/form-data" data-turbo="false" class="space-y-6">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-900 uppercase tracking-wider mb-4 flex items-center gap-2">
                                    <span class="w-6 h-6 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center text-xs">1</span>
                                    Identitas Dasar
                                </h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $user->name) }}" required
                                               class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all bg-slate-50 focus:bg-white">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="email" name="email" value="{{ old('email', $user->email) }}" required
                                               class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all bg-slate-50 focus:bg-white text-slate-500">
                            ...
                            <div class="pt-6 border-t border-slate-100 flex items-center justify-end gap-3">
                                ...
                                <button type="submit" class="px-6 py-2.5 text-white font-bold text-sm bg-purple-600 rounded-xl hover:bg-purple-700 transition-all shadow-lg shadow-purple-500/30 flex items-center gap-2">
