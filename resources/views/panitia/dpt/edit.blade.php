    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white/70 backdrop-blur-xl rounded-3xl border border-white/50 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-slate-100 flex items-center justify-between">
                ...
                <a href="{{ route('panitia.dpt.index') }}" class="text-slate-400 hover:text-slate-600 transition-colors">
            ...
            <form method="POST" action="{{ route('panitia.dpt.update', ['mahasiswa' => $mahasiswa->id]) }}"
                class="p-8 space-y-6">
                @csrf
                @method('PUT')
