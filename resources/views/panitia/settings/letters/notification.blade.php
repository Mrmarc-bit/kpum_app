<x-layouts.panitia title="Template Pemberitahuan">
    <div x-data="{
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-2">
            <div>
                <h1 class="text-xl sm:text-2xl font-black text-slate-800 tracking-tight">Template Surat Pemberitahuan</h1>
                <p class="text-slate-500 mt-1 font-medium text-sm sm:text-base">Sesuaikan format surat pemberitahuan pemungutan suara.</p>
            </div>
                ...
                <div class="grid gap-5">
                    <div>
                        ...
                        <input type="text" name="notification_header" x-model="header"
                            class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all font-bold text-slate-800 placeholder:text-slate-400 text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="notification_title" x-model="title"
                            class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all font-black text-slate-800 tracking-tight text-sm">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                         <div>
                            ...
                            <input type="text" name="notification_date" x-model="schedule_date"
                                class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-purple-100 focus:border-purple-500 transition-all text-sm font-bold text-slate-800">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="notification_location" x-model="voting_location"
                            class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all font-medium text-slate-800 text-sm">
                    </div>
