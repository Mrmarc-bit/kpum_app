<x-layouts.panitia title="Pengaturan Surat">
    <div class="space-y-6">
        ...
        <form id="settings-form" method="POST" action="{{ route('panitia.settings.letter.update') }}"
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Nama Penanda Tangan</label>
