<x-layouts.panitia :title="$title">
    <div class="max-w-2xl">
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-black text-slate-800 uppercase tracking-tight">Tambah Agenda Baru</h1>
            <p class="text-slate-500 text-sm">Buat agenda kegiatan baru untuk ditampilkan di timeline.</p>
        </div>

        <form action="{{ route('panitia.timeline.store') }}" method="POST"
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="title" id="title" required value="{{ old('title') }}"
                    class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-hidden text-sm font-bold placeholder:font-normal"
            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <select name="status" id="status" required
                        ...
                        <option value="active" {{ old('status') === 'active' ? 'selected' : '' }}>Berlangsung</option>
                ...
                <div class="space-y-2">
                    <label for="order"
                        ...
                        Tampil</label>
                    <input type="number" name="order" id="order" required value="{{ old('order', 0) }}"
                        class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-hidden text-sm font-bold">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="3"
                    ...
                    placeholder="Berikan penjelasan singkat mengenai kegiatan ini...">{{ old('description') }}</textarea>
