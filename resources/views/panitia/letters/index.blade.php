                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors" data-status="{{ $file->status }}">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form action="{{ route('panitia.reports.destroy', $file->id) }}" method="POST" class="delete-form" data-confirm="File download ini akan dihapus permanen dari sistem. Tindakan ini tidak dapat dibatalkan.">
                                            @csrf
                                            @method('DELETE')
