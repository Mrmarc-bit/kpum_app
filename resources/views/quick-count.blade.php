<x-layouts.guest title="Quick Count Real-Time">
    @push('head')
        <!-- Fonts & Scripts Specific to Quick Count -->
        ...
        <script type="application/ld+json">
        {
          ...
          "{{ '@' }}type": "Dataset",
          "name": "Hasil Perolehan Suara Sementara (Quick Count) KPUM UNUGHA 2026",
          "description": "Data real-time perolehan suara pemilihan Presiden Mahasiswa dan DPM UNUGHA Cilacap.",
          "url": "{{ url('/quick-count') }}",
    ...
    <div x-data="quickCountData()" x-init="initData()">
        ...
        <footer class="bg-white border-t border-slate-200 py-8 text-center shrink-0">
