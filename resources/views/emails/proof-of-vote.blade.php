                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 20px;">
                                        @if(\App\Models\Setting::get('app_logo'))
                                            <img src="{{ url('storage/' . \App\Models\Setting::get('app_logo')) }}" alt="Logo" width="80" height="80" style="display: block; border: 0; background-color: #ffffff; padding: 5px; border-radius: 50%;">
                                        @else
