<x-layouts.kpps title="Profil Saya">
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Kelola informasi akun petugas KPPS Anda.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <!-- Tips / Info Card -->
                <div class="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg shadow-indigo-500/20 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-indigo-100 text-sm leading-relaxed">
                            Jaga kerahasiaan password Anda. Logout setelah selesai bertugas.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <form action="{{ route('kpps.profile.update') }}" method="POST" enctype="multipart/form-data" data-turbo="false" class="space-y-6">
                            @csrf
                            @method('PUT')
