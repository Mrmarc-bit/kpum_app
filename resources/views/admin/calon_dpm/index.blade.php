<x-layouts.admin :title="$title">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        ...
        <a href="{{ route('admin.calon_dpm.create') }}"
                ...
                <div class="p-8 flex-1 flex flex-col bg-white relative">
                    ...
                    <div class="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('admin.calon_dpm.edit', $calon->id) }}"
                            ...
                            <form action="{{ route('admin.calon_dpm.destroy', $calon->id) }}" method="POST"
        ...
        @empty
            <div class="col-span-full py-20 bg-slate-50 rounded-[3rem] border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-center">
                ...
                <a href="{{ route('admin.calon_dpm.create') }}" class="px-6 py-3 bg-purple-600 text-white font-bold rounded-xl hover:bg-purple-700 transition-colors shadow-lg shadow-purple-500/30">
                    Tambah Calon DPM
                </a>
            </div>
        @endforelse
