<x-layouts.admin title="Manajemen Enkripsi Vote">
    <div class="space-y-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-black text-slate-800">🔐 Manajemen Enkripsi Vote</h1>
                <p class="text-slate-500 mt-2">Kontrol tingkat keamanan dan enkripsi data voting mahasiswa.</p>
            </div>
            <a href="{{ route('admin.audit.encryption') }}" 
               class="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-500/30">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                </svg>
                Lihat Audit Enkripsi
            </a>
        </div>
        ...
        <div class="bg-white rounded-3xl p-10 shadow-xl border border-slate-100">
            ...
            <form id="encryptionForm" method="POST" action="{{ route('admin.security.encryption.update') }}" class="space-y-8">
                ...
                <div class="flex items-center justify-between pt-6 border-t border-slate-200">
                    ...
                    <button type="submit" 
                            class="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold text-lg rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-xl shadow-indigo-500/30 hover:scale-105">
