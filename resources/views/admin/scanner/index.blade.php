<x-layouts.admin :title="$title">
    ...
    <script>
        ...
        async function performCheckDpt() {
            ...
            try {
                const response = await fetch("{{ route('admin.scanner.search-dpt') }}", {
                     method: 'POST',
                     headers: {
        ...
        async function checkManualCode() {
            ...
            try {
                const response = await fetch("{{ route('admin.scanner.check-access') }}", {
                     method: 'POST',
        ...
        async function submitManualValidation() {
            ...
            try {
                const response = await fetch("{{ route('admin.scanner.verify-manual') }}", {
                     method: 'POST',
                     headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '{{ csrf_token() }}' },
