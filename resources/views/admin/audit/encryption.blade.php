<x-layouts.admin title="Verifikasi Enkripsi Vote">
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-xl md:text-2xl font-bold text-slate-800 tracking-tight">Audit Enkripsi Suara</h1>
                <p class="text-slate-500 mt-1 text-sm md:text-base">Verifikasi integritas dan tingkat enkripsi data voting.</p>
            </div>
        </div>

        <!-- Current Encryption Level -->
        <div class="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl p-6 md:p-8 text-white shadow-2xl">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl md:text-3xl font-black mb-2">Mode Enkripsi Aktif</h2>
                    <p class="text-indigo-100 text-xs md:text-sm mb-4">Level enkripsi yang sedang digunakan untuk vote baru.</p>
                    ...
                    <div class="inline-flex items-center gap-3 px-4 md:px-6 py-2 md:py-3 bg-white/20 backdrop-blur-md rounded-xl">
                        ...
                        <span class="text-base md:text-xl font-bold">{{ $levelLabels[$currentLevel] ?? 'Unknown' }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl p-6 md:p-8 border border-slate-100 shadow-xl overflow-hidden">
            <h3 class="text-lg md:text-xl font-bold text-slate-800 mb-6">Recent Encrypted Votes (20 Latest)</h3>
