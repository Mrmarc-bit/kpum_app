    ...
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div class="bg-white rounded-3xl border border-red-200 shadow-xl shadow-red-500/10 overflow-hidden">
            <div class="p-8 space-y-6">
                ...
                <form action="{{ route('admin.reset.store') }}" method="POST" class="space-y-6" data-confirm="PERHATIAN: Apakah Anda BENAR-BENAR yakin? Seluruh data suara akan dihapus permanen dan tidak dapat dikembalikan!">
                    @csrf
