...
class CalonDpmController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.calon_dpm.index', [
    ...
    {
        return view('admin.calon_dpm.create', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.calon_dpm.index')->with('success', 'Calon DPM berhasil ditambahkan');
        } catch (\Exception $e) {
    ...
    {
        return view('admin.calon_dpm.edit', [
    ...
    public function update(Request $request, CalonDpm $calonDpm)
    {
        ...
        try {
            ...
            return redirect()->route('admin.calon_dpm.index')->with('success', 'Calon DPM berhasil diperbarui');
        } catch (\Exception $e) {
    ...
    public function destroy(CalonDpm $calonDpm)
    {
        try {
            ...
            return redirect()->route('admin.calon_dpm.index')->with('success', 'Calon DPM berhasil dihapus');
        } catch (\Exception $e) {
