...
class AssetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.assets.index', compact('assets', 'folders', 'currentFolder'));
    }
            ...
            try {
                $this->assetService->uploadAsset(
                    ...
                    [
                        ...
                        'name' => pathinfo($file->getClientOriginalName(), PATHINFO_FILENAME), // Default name
                        'description' => null
                    ],
                    Auth::id()
                );
                ...
                // Audit Log per file (optional, maybe too spammy if many files)
    ...
    public function destroyFolder(AssetFolder $folder)
    {
        ...
        // Database cascade delete will handle children.
        // But physical files of assets inside folder need to be deleted too?
        // This is tricky. Cascade delete on DB cleans DB rows, but FILES REMAIN on disk.
        
        // Solution: Recursively delete files.
        // For simple MVP: Just delete DB row is dangerous (orphan files).
        // Let's defer delete folder logic that cleans files for now or block delete if not empty.
